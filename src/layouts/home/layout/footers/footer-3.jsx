            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12">
              <div className="edu-footer-widget">
                ...
                <p className="description">
                  Lorem ipsum dolor amet consecto adi pisicing elit sed eiusm tempor incidid unt
                ...
                <div className="inner">
                  ...
                  <div className="widget-information">
                    <ul className="information-list">
                      ...
                      <li>
                        <span>Email:</span>
                        <a href="mailto:info@edublink.com" target="_blank" rel="noreferrer">
                          info@edublink.com
                        </a>
                      </li>
                    </ul>
            ...
            <div className="col-lg-12">
              <div className="inner text-center">
                <p>
                  ...
                  <a href="https://1.envato.market/AoJezj" rel="noreferrer" target="_blank">
                    EduBlink
                  </a>{" "}
                  Designed By{" "}
                  <a href="https://1.envato.market/YgGJbj" target="_blank" rel="noreferrer">
                    DevsBlink
                  </a>
                  . All Rights Reserved
                </p>
