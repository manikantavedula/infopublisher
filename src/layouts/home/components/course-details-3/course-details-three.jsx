                    ...
                    >
                      <div className="course-tab-content">
                        <div className="course-overview">
                          ...
                          <ul className="mb--50">
                            <li>
                              No prior knowledge of Wordpress is required as everything will be
                              covered in this course.
                            </li>
                            <li>Basic HTML and CSS knowledge helps, but {"isn't"} a must-have</li>
                            <li>
                              You {"don't"} need any coding experience at all. That is the beauty of
                              Wordpress.
                            </li>
                          ...
                          <div className="accordion edu-accordion" id="accordionExample">
                                ...
                                <div className="accordion-body">
                                  <div className="course-lesson">
                                    <div className="reading-status">
                                      <h5 className="title">
                                        <i className="icon-65"></i> Lesson Content
                                      </h5>
                            ...
                            <div className="accordion-item no-collapsed">
                              <h2 className="accordion-header">
                                <button className="accordion-button">Lesson 1.2</button>
                              </h2>
                            </div>

                            <div className="accordion-item no-collapsed">
                              <h2 className="accordion-header">
                                <button className="accordion-button">Lesson 1.3</button>
                              </h2>
                            </div>
                            ...
                            <div className="accordion-item no-collapsed">
                              <h2 className="accordion-header">
                                <button className="accordion-button">Lesson 2.1</button>
                              </h2>
                            </div>

                            <div className="accordion-item no-collapsed">
                              <h2 className="accordion-header">
                                <button className="accordion-button">Lesson 2.2</button>
                              </h2>
                            </div>
                            ...
                            <div className="accordion-item no-collapsed">
                              <h2 className="accordion-header">
                                <button className="accordion-button">Lesson 3.2</button>
                              </h2>
                            </div>

                            <div className="accordion-item no-collapsed">
                              <h2 className="accordion-header">
                                <button className="accordion-button">Lesson 3.3</button>
                              </h2>
                            </div>
                          </div>
                        </div>
