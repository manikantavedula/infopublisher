            ...
            <div className="col-lg-5 order-lg-2">
              <div className="shop-content">
                <div className="section-title section-left splash-title">
                  <span className="pre-title" data-sal="slide-up" data-sal-duration="1000">
                    Online Store
                  </span>
                  ...
                  <p data-sal-delay="100" data-sal="slide-up" data-sal-duration="1000">
                    E-commerce. EduBlink provides all the tools you need to start selling online.
                    Let your customers to experience E-commerce at its absolute-best.
                  </p>

                  <div data-sal-delay="400" data-sal="slide-up" data-sal-duration="1000">
                    <Link to="/course-style-1">
