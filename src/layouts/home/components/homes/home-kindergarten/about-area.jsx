          ...
          <div className="col-lg-6">
            <div className="about-content">
              ...
              >
                ...
                <p>
                  Magna aliquaenim minim veniam quis nostrud exercitation ullamco laborisLorem ipsum
                  dolor sit amet consectetur adipisicing elit sed do eius tempor incididunt labore.
                </p>
              </div>
              <div
              ...
              >
                <div className="row g-5 row--20">
                  <div className="col-lg-6">
                    ...
                    <p>
                      Magna aliquaenim minim veniamquis nostrud exercitation ulamco laboris Lorem
                  ...
                  <div className="col-lg-6">
                    ...
                    <p>
                      Consectetur do eius adipisicing elit sed do eius tempor incididunt labore.
                    </p>
                    <p>
                      dolore magna aliqua. Ut enim ad minim veniam quis nosud exercitation ulamco.
                    </p>
                  </div>
                </div>
              </div>
