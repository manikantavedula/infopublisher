            ...
            <div className="edu-blog blog-style-2 first-large-blog">
              <div className="inner">
                <div className="thumbnail">
                  <Link to={`/blog-details/${large_blog.id}`}>
                    <a>
                ...
                <div className="content">
                  ...
                  <p>
                    Lorem ipsum dolor sit amet consec tetur adipisicing sed eiusmod tempor incid
                    idunt labore.
                  </p>
                  <ul className="blog-meta">
                    <li>
                      <i className="icon-25"></i>By <a href="#">{large_blog.author}</a>
                    </li>
                    <li>
