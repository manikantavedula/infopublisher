...
const lists = ["Cooking award achived", "Available online courses", "Online Certification"];
    ...
    <div className="edu-section-gap edu-about-area about-style-5">
      <div className="container">
        ...
        >
          ...
          <h2 className="title">
            Hi! I am <span className="color-primary">Simon Baker</span> <br /> and I Offer to
            Develope Your Skill <br /> Through Yoga
          </h2>
        </div>
