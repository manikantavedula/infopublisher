                      ...
                      >
                        ...
                        <AccordionDetails>
                          {x.data.length > 0 &&
                            x.data.map((y, l) => (
                              <Accordion
                                expanded={expandedLesson === `panellesson${i + j + k + l + 1}`}
                                onChange={handleChangeAccLesson(`panellesson${i + j + k + l + 1}`)}
                                ...
                                <AccordionDetails>
                                  {y.parts.length > 0 &&
                                    y.parts.map((z, m) => (
                                      <Accordion
                                        expanded={
                                          expandedParts === `panelparts${i + j + k + l + m + 1}`
                                        }
                                              ...
                                              <IconButton
                                                ...
                                                onClick={() =>
                                                  onOpenVideoModal({
                                                    ...
                                                    name: z.name,
                                                    partNo: z.partNo,
                                                    liveVideoId: extractVideoId(z.liveVideoId),
                                                  })
                                                }
                                              >
                                                <IconVideo size="24px" />
