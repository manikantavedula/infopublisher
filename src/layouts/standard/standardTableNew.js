...
export default function StandardTableNew({
  filtereddata,
  onOpenEditModal,
  onOpenDeleteModal,
  onOpenViewModal,
      ...
      <Table sx={{ minWidth: 700, boxShadow: "none" }} size="small" aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="left">Standard</StyledTableCell>
          ...
          {rows &&
            rows.map((row) => (
              <StyledTableRow key={row.standard}>
                ...
                <StyledTableCell align={columns[1].align}>{row.standard}</StyledTableCell>
